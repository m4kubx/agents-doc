...
# Design Review Checklist — TaskManager
...
| 3 | tasks-list.html | `⬜ pending` | |
| 4 | task-form.html | `⬜ pending` | |
| 5 | 403.html | `⬜ pending` | |
| 6 | 404.html | `⬜ pending` | |
| 7 | 500.html | `⬜ pending` | |

### Criterios por Mockup
- [ ] El layout corresponde al tipo especificado (sidebar, minimal)
...
- [ ] Todas las vistas del routing-tree.md existen en 01-views/
