...
**Solucion**: Siempre pide autocr�tica.
...
## 11. Permitir que el agente genere o proponga sin orden expl�cita

**Error**: El agente agrega funcionalidades, decide tecnolog�as o propone cambios que nunca le pediste ("creo que ser�a buena idea...").

**Consecuencia**: El proyecto deriva, pierdes control y gastas tiempo revisando trabajo no solicitado.

**Solucion**: Activa siempre el [Principio de No Generaci�n Sin Orden](principio-no-generacion-sin-orden.md). Exige que pregunte antes de actuar. Nunca digas "haz lo que creas mejor".

## 12. No forzar razonamiento estructurado en tareas complejas

**Error**: El agente "salta" a una soluci�n o conclusi�n sin haber razonado paso a paso (Chain of Thought).

**Consecuencia**: Decisiones superficiales, tradeoffs no considerados, suposiciones ocultas, soluciones sub�ptimas.
...
## 13. No hacer surfacing expl�cito de suposiciones
...
**Consecuencia**: Errores que aparecen tarde, cuando ya hay mucho c�digo escrito.

**Solucion**: Obliga al agente a listar **todas** las suposiciones usando `plantilla-suposiciones-explicitas.md` antes de proponer o implementar cualquier cosa importante. Revisa y aprueba las suposiciones expl�citamente.

## 14. Aceptar la primera respuesta sin auto-cr�tica del agente

**Error**: El agente entrega su primer borrador sin haberse revisado a s� mismo contra la instrucci�n original.

**Consecuencia**: M�s iteraciones de correcci�n manual, respuestas con omisiones o desviaciones.

**Solucion**: Exige siempre que el agente aplique `plantilla-autocritica-integrada.md` antes de mostrarte cualquier respuesta importante (especialmente specs, c�digo, revisiones).
...
- Para el ciclo completo de trabajo: sigue la metodolog�a en [README.md](README.md)
...
- Para proyectos grandes con m�ltiples agentes: consulta [patron-orchestrator.md](patron-orchestrator.md) y [matriz-roles-agentes.md](matriz-roles-agentes.md)
- Para razonamiento profundo y reducci�n de suposiciones ocultas: usa [plantilla-razonamiento-estructurado.md](plantilla-razonamiento-estructurado.md) y [plantilla-suposiciones-explicitas.md](plantilla-suposiciones-explicitas.md)
- Para que el agente se revise antes de entregar: usa [plantilla-autocritica-integrada.md](plantilla-autocritica-integrada.md)
- Para salidas consistentes y f�ciles de consumir: usa [plantilla-formato-salida-estructurado.md](plantilla-formato-salida-estructurado.md)
