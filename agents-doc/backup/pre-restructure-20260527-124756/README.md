...
>
> Este principio está documentado en detalle en [[principio-no-generacion-sin-orden]].
>
...
|-----------|---------------|
| [[plantilla-arquitectura]] | Fase 1: antes de escribir cualquier código |
| [[plantilla-implementacion]] | Fase 3: para implementar un módulo específico |
| [[plantilla-revision]] | Después de cada implementación |
| [[plantilla-tests-automaticos]] | Junto con la implementación (alta prioridad) |
| [[plantilla-gestion-contexto]] | Al iniciar cada nuevo chat del mismo proyecto (usa v2 para proyectos grandes) |
| [[guia-iteracion-refactorizacion]] | Cuando necesites mejorar código existente sin romperlo |
...
| [[matriz-roles-agentes]] | Cuando necesites elegir el rol correcto del agente |
| [[workflow-git-con-agentes]] | Siempre (control de versiones profesional) |
| [[ejemplos-por-stack]] | Para ver la metodología aplicada en stacks reales |

**Nuevas plantillas de alta eficiencia (recomendadas para uso frecuente):**
| Plantilla | Cuando usarla |
|-----------|---------------|
| [[plantilla-razonamiento-estructurado]] | Antes de cualquier decisión compleja (arquitectura, debugging, SDD, tradeoffs) |
| [[plantilla-autocritica-integrada]] | Antes de aceptar cualquier respuesta importante del agente |
| [[plantilla-gestion-contexto-v2]] | Proyectos medianos/grandes o de larga duración (reemplaza a la v1) |
| [[plantilla-suposiciones-explicitas]] | Antes de proponer o implementar cualquier funcionalidad con lógica de negocio |
| [[plantilla-formato-salida-estructurado]] | Cuando necesites salidas consistentes, parseables o para handoff entre agentes |
