...
2. Usa la plantilla dedicada: `plantilla-suposiciones-explicitas.md`
...
- "Aplica surfacing de suposiciones explícitas usando la plantilla correspondiente."
...
- Fase 1 (Arquitectura): El agente propone, **tú apruebas**, solo entonces se avanza. Combínalo con `plantilla-razonamiento-estructurado.md` y `plantilla-suposiciones-explicitas.md`.
- Fase 3 (Implementación por módulo): Orden explícita + principio activado = "Ahora implementa solo el módulo X siguiendo la arquitectura aprobada". Usa `plantilla-autocritica-integrada.md` antes de aceptar entregas.
